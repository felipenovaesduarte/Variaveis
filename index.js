...
var mensagemBoasVindas = "Bem-vindo(a), " + nomeCompleto + "!";
...
var horas = Math.floor(duracaoEmMinutos / 60); // Calcula quantas horas
var minutos = duracaoEmMinutos % 60; // Calcula os minutos restantes
